...
const (
	HelloService_SayHello_FullMethodName                       = "/hello_service.HelloService/SayHello"
	HelloService_SayHelloServerStreaming_FullMethodName        = "/hello_service.HelloService/SayHelloServerStreaming"
	HelloService_SayHelloClientStreaming_FullMethodName        = "/hello_service.HelloService/SayHelloClientStreaming"
	HelloService_SayHelloBidirectionalStreaming_FullMethodName = "/hello_service.HelloService/SayHelloBidirectionalStreaming"
)
...
type HelloServiceClient interface {
	...
	SayHelloServerStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (HelloService_SayHelloServerStreamingClient, error)
...
func (c *helloServiceClient) SayHelloServerStreaming(ctx context.Context, in *NameList, opts ...grpc.CallOption) (HelloService_SayHelloServerStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], HelloService_SayHelloServerStreaming_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *helloServiceClient) SayHelloClientStreaming(ctx context.Context, opts ...grpc.CallOption) (HelloService_SayHelloClientStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[1], HelloService_SayHelloClientStreaming_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *helloServiceSayHelloClientStreamingClient) CloseAndRecv() (*MessageList, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(MessageList)
...
func (c *helloServiceClient) SayHelloBidirectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (HelloService_SayHelloBidirectionalStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[2], HelloService_SayHelloBidirectionalStreaming_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type HelloServiceServer interface {
	...
	SayHelloServerStreaming(*NameList, HelloService_SayHelloServerStreamingServer) error
...
func (UnimplementedHelloServiceServer) SayHelloServerStreaming(*NameList, HelloService_SayHelloServerStreamingServer) error {
...
func (x *helloServiceSayHelloClientStreamingServer) SendAndClose(m *MessageList) error {
	return x.ServerStream.SendMsg(m)
}
